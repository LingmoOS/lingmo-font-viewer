...
/*
 * font-view: a font viewer for Lingmo
 *
...
action_about (GSimpleAction *action, GVariant *parameter, gpointer user_data)
{
    ...
    adw_show_about_window (GTK_WINDOW (self->main_window),
                           ...
                           "website", "https://gitlab.lingmo.org/Lingmo/lingmo-font-viewer/",
                           "issue-url", "https://gitlab.lingmo.org/Lingmo/lingmo-font-viewer/-/issues/new",
...
font_view_application_new (void)
{
    return g_object_new (FONT_VIEW_TYPE_APPLICATION,
                         ...
                         "resource-base-path", "/org/lingmo/font-viewer/",
                         NULL);
}
